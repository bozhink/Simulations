 ...
 * 
 *          This class contains the matrix and the most important methods of the
 *          implementation of the Bak-Tang-Wiesenfeld (BTW) sandpile model.
 */

public class BTWRecursiveModel {
	 ...
	 */
	public BTWRecursiveModel(int nx, int ny) {
		this.nx = nx;
		this.ny = ny;
	...
	/**
	 * Limitation for the recursion depth. This parameter is used to avoid the
